...
public class ChecklistController {
    ...
    public ResponseEntity<ChecklistResponseDTO> createGroupChecklist(
    ...
    @PostMapping("/me")
    public ResponseEntity<ChecklistResponseDTO> createPersonalChecklist(
            @Parameter(description = "체크리스트 생성 요청 데이터", required = true)
            @RequestBody ChecklistRequestDTO checklistRequestDTO,
            @AuthenticationPrincipal CustomOAuth2User user) {
    ...
    public ResponseEntity<List<ChecklistResponseDTO>> getGroupChecklist(
            @Parameter(description = "그룹 ID", required = true)
            @PathVariable UUID groupId,
            @AuthenticationPrincipal CustomOAuth2User user) {
        UUID userId = user.getUserId();
        ...
        return ResponseEntity.ok(checklistResponseDTOs);
    }
    ...
    @GetMapping("/me")
    public ResponseEntity<List<ChecklistResponseDTO>> getPersonalChecklist(@AuthenticationPrincipal CustomOAuth2User user) {
        UUID userId = user.getUserId();
    ...
    public ResponseEntity<ChecklistResponseDTO> updateGroupChecklist(
            @Parameter(description = "그룹 ID", required = true)
            @PathVariable UUID groupId,
    ...
    public ResponseEntity<ChecklistResponseDTO> updatePersonalChecklist(
            @Parameter(description = "체크리스트 ID", required = true)
            @PathVariable Long checklistId,
            @Parameter(description = "체크리스트 수정 요청 데이터", required = true)
            @RequestBody ChecklistRequestDTO checklistRequestDTO,
    ...
    public ResponseEntity<ChecklistResponseDTO> completeChecklist(
            @Parameter(description = "체크리스트 ID", required = true)
            @PathVariable Long checklistId,
            @AuthenticationPrincipal CustomOAuth2User user) {
    ...
    public ResponseEntity<ChecklistResponseDTO> undoChecklist(
            @Parameter(description = "체크리스트 ID", required = true)
            @PathVariable Long checklistId,
            @AuthenticationPrincipal CustomOAuth2User user) {
